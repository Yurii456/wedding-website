(function (win, doc) {
  ...
  var getDefaultInviteText = function (names) {
    ...
    return (
      `Дорогі ${inviteNames}! Запрошуємо вас розділити один із найважливіших днів у нашому житті. Для нас велика радість провести його поруч із людьми, яких ми любимо та цінуємо. Будемо щасливі бачити вас на нашому весіллі.`
    );
  };
